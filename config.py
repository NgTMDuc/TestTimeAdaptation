...
def get_args():
    ...
    parser.add_argument("--pretrained_folder", type = str, default = "../pretrained/" )
    ...
    parser.add_argument('--cmmodel_name', default='ColoredMNIST_model.pth', type=str, help='ColoredMNIST pre-trained model path')
